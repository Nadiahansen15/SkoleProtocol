...
class ShowAttendanceTest(LiveServerTestCase, unittest.TestCase):
  ...
  def test1(self):
    driver = webdriver.Chrome(executable_path=r"/Users/christianholm/Desktop/SoftwareDevelopment/Testing/SkoleProtocol/chromedriver-2")
  ...
  def test2(self):
    ...
    username.send_keys('christian')
    password.send_keys('Tino2021')
    time.sleep(1.5)
  ...
  def test4(self):
      ...
      username_student.send_keys('christian')
      ...
      username_new_student.send_keys('christian') # correct
      password_new_student.send_keys('Tino2021')
  ...
  def test5(self):
    ...
    check_text = driver.find_element_by_id('create att code').text
    correct_str = 'Create attendance code'
    
    if self.assertEquals(check_text, correct_str) is None:
      print('Attendance Code too long test passed: ', self.assertEquals(check_text, correct_str) is None)
      time.sleep(1)
    ...
    check_text_new2 = driver.find_element_by_id('create att code').text
    correct_str_new2 = 'Create attendance code'
    
    if self.assertEquals(check_text_new2, correct_str_new2) is None:
      print('Attendance Code wrong class test passed: ', self.assertEquals(check_text_new2, correct_str_new2) is None)
      time.sleep(1.5)
      logout = driver.find_element_by_id("logout")
      logout.send_keys(Keys.RETURN)
      time.sleep(1.5)
    ...
    check_text_new3 = driver.find_element_by_id('create att code').text
    correct_str_new3 = 'Create attendance code'
    
    if self.assertEquals(check_text_new3, correct_str_new3) is None:
      print('Attendance Code wrong subject test passed: ', self.assertEquals(check_text_new3, correct_str_new3) is None)
      time.sleep(1.5)
      logout = driver.find_element_by_id("logout")
      logout.send_keys(Keys.RETURN)
      time.sleep(1.5)
